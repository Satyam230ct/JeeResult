...
public class FullResult extends javax.swing.JFrame {
     ...
     */
   JTable table;
   String[] columnNames = {"Rank","Rollno","Name", "Marks"};
   DefaultTableModel model;
    ...
    public FullResult() {
        ...
        String query = "select * from student order by tm desc,mm desc,pm desc ,cm desc";
         
            
        model.addRow(new Object[]{"Rank","Rollno","Name", "Marks"});
...
//            t1.setWrapStyleWord(true);
            ...
            while(result.next()){
                ...
                String name = result.getString("name");
                  ...
                  model.addRow(new Object[]{i,roll,name,tm});
                  System.out.printf("\n"+roll+"\t\t\t"+name+"\t\t\t"+tm+"\t\t\t"+i);
